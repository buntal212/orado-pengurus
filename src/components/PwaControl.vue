    ...
    <q-card class="install-card">
      ...
      <q-card-section class="q-pt-none">
        <div class="benefit">
          ...
          <span>Terbuka seperti aplikasi biasa.</span>
        </div>
        <div class="benefit">
          <q-icon name="system_update" color="primary" />
          <span>Selalu mendapat pemberitahuan versi terbaru.</span>
        </div>
  ...
  <q-dialog v-model="updateDialog" persistent>
    <q-card class="install-card">
      <q-card-section class="install-head text-center">
        ...
        <div class="text-caption text-blue-grey-7 q-mt-xs">
          Versi terbaru ORADO sudah siap. Perbarui agar fitur dan perbaikan terbaru dapat digunakan.
        </div>
      </q-card-section>
      <q-card-actions align="right" class="q-px-md q-pb-md">
...
const isInstalled = () =>
  ...
  window.localStorage.getItem(installStateKey) === '1'
const manualGuide = computed(() =>
  isIos
